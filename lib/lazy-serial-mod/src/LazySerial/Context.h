...
namespace LazySerial
{
  ...
  namespace CallingMode
  {
    enum CallingMode
    {
      GET_METADATA, // Update the passed context object with name, usage string, and description string for help/usage printing.
  ...
  public:
    ...
    const __FlashStringHelper *command_name;        // for usage printing, if applicable
    const __FlashStringHelper *command_usage;       // for usage printing, if applicable
    const __FlashStringHelper *command_description; // for help/usage printing, if applicable
  }; // struct
} // namespace
